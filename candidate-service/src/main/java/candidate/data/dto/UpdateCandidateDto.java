...
public record UpdateCandidateDto(@Positive(message = "candidateId не может быть пустым.") Integer candidateId,

		@NotBlank(message = "Имя пользователя не может быть пустым.") String firstName,
