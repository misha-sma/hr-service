...
CREATE TABLE event(event_id serial PRIMARY KEY, candidate_id integer, message text NOT NULL, is_sent boolean DEFAULT false, create_date timestamp without time zone DEFAULT now());
